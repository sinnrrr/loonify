<template>
  <b-navbar class='has-background-transparent mb-6'>
    ...
    <template #brand>
      ...
      <b-navbar-item
        tag='nuxt-link'
        :to="{ name: 'index' }"
        class='logo-text is-hidden-mobile'>
        Lost and Found<br>of the Future
      </b-navbar-item>
    </template>
    ...
    <template #end>
      <b-navbar-item
        tag='div'
        class='is-size-4 is-uppercase has-text-weight-bold'>
        ...
        <b-navbar-item v-if="$route.name !== 'office-new'">
          <b-button
            tag='nuxt-link'
            class='is-warning'
            :to="{ name: 'office-new' }">
        ...
        <b-navbar-item v-if='!$auth.user'>
          <b-button
            tag='nuxt-link'
            type='is-primary'
            :to="{ name: 'index-signup' }">
            Sign up
          </b-button>
        </b-navbar-item>
        <b-navbar-item v-if='!$auth.user'>
